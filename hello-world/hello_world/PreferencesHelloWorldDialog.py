...
class PreferencesHelloWorldDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesHelloWorldDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesHelloWorldDialog object.
        """
        builder = get_builder('PreferencesHelloWorldDialog')
        new_object = builder.get_object("preferences_hello_world_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesHelloWorldDialog object with it in order to
        finish initializing the start of the new PerferencesHelloWorldDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesHelloWorldDialog()
    dialog.show()
    gtk.main()
